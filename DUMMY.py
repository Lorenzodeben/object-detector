...
class ObjectDetection:
    ...
    def trackbars(self):
        ...
        cv2.createTrackbar("spec_x(0)","Parameters",193,1048,self.empty)
        cv2.createTrackbar("spec_y(0)","Parameters",258,1048,self.empty)
        cv2.createTrackbar("spec_x(end)","Parameters",378,1048,self.empty)
        cv2.createTrackbar("spec_y(end)","Parameters",423,1048,self.empty)
        ...
        while True:
            ...
            for i in range(len(colors)):
                ...
                for c in contours:
                    ...
                    object_shape = self.detect_shape(c)
                    ...
                    if color == color and object_shape == shape:
                        # Draw a label "User Object" at the centroid of the object
                        cv2.putText(frame, "User Object", (cx + 10, cy), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                                    (255, 255, 255), 2)
                        ...
                        cv2.putText(frame, "Undefined Object", (cx + 10, cy), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                                    (10, 10, 10), 2)
